...
//injeção de dependecia com o repositorio user
	...
	public void run(String... args) throws Exception {
		...
		//para salvar um objeto dependente na relação de 1para1, nao e necessario chamar o repository
		// faz a associação de mão deupla em memória
		o1.setPayment(pay1);
		//e chama para salvar novamente o pedido
